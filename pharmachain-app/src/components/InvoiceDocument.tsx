            ...
            {itemsList.map((it: any, idx: number) => {
              ...
              return (
                <tr key={idx}>
                  ...
                  <td className="py-2.5 px-2 text-center font-mono border-r border-slate-300 whitespace-nowrap">
                    <span className="font-bold text-slate-900 block">{it.batch_no || "EV2026-C01"}</span>
                    <span className="text-[9px] text-slate-500 block mt-0.5">{it.expiry_date || "12/2028"}</span>
                  </td>
