    ...
    <aside className="w-64 bg-[#0b2341] text-white flex flex-col justify-between p-4 h-full border-r border-slate-800 shrink-0 overflow-y-auto scrollbar-thin">
      ...
      <div className="space-y-6">
        <Link href="/" className="flex flex-col space-y-1 pt-1 px-2 cursor-pointer">
          ...
          <div className="flex items-center space-x-2 pl-0.5 mt-0.5">
            <span className="text-[9px] text-[#F3D0E9] font-extrabold tracking-wider uppercase block">
              Distributor Portal
            </span>
            <span className="text-[8px] bg-[#A71380]/30 text-[#F3D0E9] px-2 py-0.5 rounded-[4px] border border-[#F3D0E9]/40 font-black uppercase">
              B2B
            </span>
          </div>
        </Link>
            ...
            return (
              ...
              >
                ...
                {item.badge && item.badge > 0 ? (
                  <span
                    className={`text-[10px] font-black px-2 py-0.5 rounded-[4px] ${isCurrent
      ...
      {/* Bottom Section */}
      <div className="space-y-3 border-t border-slate-800/80 pt-4 mt-auto">
